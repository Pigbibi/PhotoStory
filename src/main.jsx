...
const errors = {
  ...
  storage_limit: "图片容量已达到上限，已停止新增；现有照片保留。",
  storage_request_limit: "本月图片请求额度已用完，请检查存储设置。",
  storage_busy: "图片上传状态待核实，请稍后检查，未覆盖原图。",
  storage_conflict: "图片内容发生冲突，已停止覆盖。",
  storage_unavailable: "图片存储暂不可用，请检查 R2 连接。",
